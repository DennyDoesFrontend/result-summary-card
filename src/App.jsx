...
{/* Left section */}
      <div className='bg-gradient-to-b from-[#7857ff] to-[#2e2be9] p-10 flex flex-col gap-4 items-center justify-between rounded-b-4xl sm:rounded-4xl text-center w-full md:min-w-[320px] md:max-w-[350px] flex-[1_1_0]'>
        ...
        <div className='size-36 bg-gradient-to-b from-[#4e21ca] to-[#2421ca00] rounded-full flex flex-col items-center justify-center'>
          <h3 className='text-7xl text-white font-bold'>76</h3>
          <p className='text-[#ffffff90] font-semibold'>of 100</p>
        </div>
